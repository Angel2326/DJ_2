# Generated by Django 3.2 on 2021-07-02 18:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FM', 'ФОРМИРУТЕСЯ'), ('STP', 'ОТПРАВЛЕН В ОБРАБОТКУ'), ('PRD', 'ОБРАБОТАН'), ('PD', 'ОПЛАЧЕН'), ('RD', 'ГОТОВ К ВЫДАЧЕ'), ('CNC', 'ОТМЕНЕ'), ('DVD', 'ВЫДАН')], default='FM', max_length=3, verbose_name='статус')),
